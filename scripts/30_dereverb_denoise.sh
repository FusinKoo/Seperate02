...
WORK_DIR="$SS_WORK/$SLUG"; IN="$WORK_DIR/02_main_vocals.wav"; [[ -f "$IN" ]] || { echo "[ERR] missing $IN"; exit 3; }
...
mv -f "${cand[0]}" "$WORK_DIR/03_main_clean.wav"; echo "[OK] 30 -> 03_main_clean.wav"
